  ...
  const approvedQuotes = [
    {
      srNo: 1,
      shippingMode: 'Air',
      departureCountryCode: '', // This cell is empty in the image
      departureDistrict: '',     // This cell is empty in the image
      departureType: 'Commercial address',
      arrivalCountry: '',        // This cell is empty in the image
      arrivalDistrict: '',       // This cell is empty in the image
    ...
    // Add more quote objects here to see the table grow
  ];
  ...
  return (
    <div className="bg-gray-50 min-h-screen p-4 sm:p-6 lg:p-8">
      <div className="max-w-full mx-auto bg-white p-6 rounded-lg shadow-sm">
        <h2 className="text-2xl font-semibold text-gray-800 mb-6">Approved Quotes List</h2>
          ...
          <table className="w-full text-sm text-left text-gray-600">
            <thead className="bg-[#e6c98c] text-gray-700 uppercase text-xs whitespace-nowrap">
              <tr>
                ...
                <TableHeader>Departure Country Code</TableHeader>
                <TableHeader>Departure District</TableHeader>
                <TableHeader>Departure Type</TableHeader>
                <TableHeader>Arrival Country</TableHeader>
                <TableHeader>Arrival District</TableHeader>
            ...
            <tbody>
              {approvedQuotes.map((quote) => (
                <tr key={quote.srNo} className="bg-white border-b">
                  ...
                  <td className="px-4 py-4">{quote.departureCountryCode}</td>
                  <td className="px-4 py-4">{quote.departureDistrict}</td>
                  <td className="px-4 py-4">{quote.departureType}</td>
                  <td className="px-4 py-4">{quote.arrivalCountry}</td>
                  <td className="px-4 py-4">{quote.arrivalDistrict}</td>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mt-4 text-sm text-gray-600 gap-4">
          ...
          <div className="flex items-center">
            <button className="px-3 py-1 border border-[#d4b46a] text-[#d4b46a] rounded-l-md hover:bg-gray-100 disabled:opacity-50 disabled:text-gray-400 disabled:border-gray-300" disabled>
              Previous
            </button>
            <button className="px-4 py-1 border-t border-b text-white bg-[#d4b46a] border-[#d4b46a]">
              1
            </button>
