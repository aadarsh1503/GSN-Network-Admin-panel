...
// --- Dummy Data ---
// Add a few dummy entries for testing.
const initialRunningQuotes = [
  { id: 1, shippingMode: 'Air', departureCountry: 'China', departureState: 'Shanghai', departureType: 'Commercial address', arrivalCountry: 'USA', arrivalState: 'Los Angeles', arrivalType: 'Commercial address', arrivalDate: '2024-08-15 00:00:00', productDescription: 'Consumer Goods', packageType: 'Pallet 48x40', incoterms: 'FOB', quantity: 300, weight: '1200Kilos', size: 'N/A', additionalItems: 'fragile', additionalNote: 'Shipment in progress' },
  { id: 2, shippingMode: 'Surface (Road / Rail / Sea)', departureCountry: 'India', departureState: 'Mumbai', departureType: 'Commercial address', arrivalCountry: 'United Kingdom', arrivalState: 'London', arrivalType: 'Commercial address', arrivalDate: '2024-09-01 00:00:00', productDescription: 'Textiles', packageType: 'Container 40\'', incoterms: 'CIF', quantity: 2500, weight: '15Tonnes', size: 'N/A', additionalItems: '-', additionalNote: 'Awaiting customs clearance at destination' },
];


function RunningQuotesList() {
  // --- FIX: Initialize state with the dummy data to show it ---
  const [quotes, setQuotes] = useState(initialRunningQuotes);
  ...
  return (
    <div className="bg-gray-50 min-h-screen p-4 sm:p-6 lg:p-8">
      <div className="max-w-6xl mx-auto bg-white p-6 rounded-lg border border-gray-200">
        <h2 className="text-2xl font-semibold mb-4 text-gray-800">Running Quotes List</h2>
