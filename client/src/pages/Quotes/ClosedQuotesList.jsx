...
const ClosedQuotesList = () => {
  ...
  if (loading) return <div className="text-center py-8">Loading closed quotes...</div>;
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm">
      ...
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-semibold text-gray-800">Closed Quotes</h2>
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          <input 
            id="search"
            type="text" 
            placeholder="Search closed quotes..."
            value={searchTerm}
        ...
        <table className="min-w-full bg-white">
          <thead className="bg-[#e0c58a] text-gray-700">
            <tr>
              ...
              <SortableHeader sortKey="updated_at">Closed</SortableHeader>
          ...
          <tbody className="text-gray-700">
            {paginatedQuotes.length === 0 ? (
              <tr>
                <td colSpan="9" className="text-center py-8 text-gray-500">No closed quotes found</td>
              </tr>
            ) : (
