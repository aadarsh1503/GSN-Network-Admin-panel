...
// --- Dummy Data ---
// The data is an exact match of the content from your screenshot.
const initialClosedQuotes = [
  ...
  { id: 2, shippingMode: 'Air', departureCountry: 'American Samoa', departureState: 'Manu\'a', departureType: 'Commercial address', arrivalCountry: 'Bahrain', arrivalState: 'Mahama', arrivalType: 'Residential address', arrivalDate: '2024-01-20 00:00:00', productDescription: 'test', packageType: 'Pallet ISO 39.37x47.24', incoterms: 'FOB', quantity: 18, weight: '1Kilos', size: 'L1*W1*H1 cm', additionalItems: 'stackable,', additionalNote: 'test' },
  { id: 3, shippingMode: 'Air', departureCountry: 'Angola', departureState: 'Cunene', departureType: 'Commercial address', arrivalCountry: 'Austria', arrivalState: 'Carinthia', arrivalType: 'Commercial address', arrivalDate: '2024-01-27 00:00:00', productDescription: 'test', packageType: 'Pallet ISO 42x42', incoterms: 'CPT', quantity: 10, weight: '1Kilos', size: 'L1*W1*H1 cm', additionalItems: 'stackable,', additionalNote: 'testing 123' },
  { id: 4, shippingMode: 'Air', departureCountry: 'American Samoa', departureState: 'Manu\'a', departureType: 'Commercial address', arrivalCountry: 'Antigua And Barbuda', arrivalState: 'Saint Paul', arrivalType: 'Residential address', arrivalDate: '2024-01-21 00:00:00', productDescription: '874488', packageType: 'Pallet ISO 48x40', incoterms: 'CPT', quantity: 10, weight: '10Tonnes', size: 'L10*W10*H10 inches', additionalItems: 'stackable,', additionalNote: 'testing' },
];


function ClosedQuotesList() {
  // Data will be shown by default as requested.
  const [quotes, setQuotes] = useState(initialClosedQuotes);
  ...
  return (
    <div className="bg-gray-50 min-h-screen p-4 sm:p-6 lg:p-8">
      <div className="max-w-6xl mx-auto bg-white p-6 rounded-lg border border-gray-200">
        <h2 className="text-2xl font-semibold mb-4 text-gray-800">Closed Quotes List</h2>
              ...
              {currentEntries.length > 0 ? (
                currentEntries.map((quote) => (
                  <tr key={quote.id} className="bg-white border-b hover:bg-gray-50 align-middle">
                    ...
                    <td className="p-3 text-center">{quote.quantity}</td>
...
export default ClosedQuotesList;