...
const DisclaimerEditor = () => {
  ...
  const [htmlContent, setHtmlContent] = useState('<p>disclaimer page</p>');
  ...
  const handleSubmit = (e) => {
    ...
    alert('Disclaimer page submitted! Check the console for the HTML content.');
  };
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 bg-gray-50 min-h-screen">
      <div className="max-w-6xl mx-auto bg-white p-6 sm:p-8 rounded-lg shadow-md">
        <h1 className="text-2xl font-bold text-gray-800 mb-6">Disclaimer</h1>
