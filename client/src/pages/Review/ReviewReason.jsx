...
const reviewReasonsData = [
    { id: 1, title: 'Warehouse Operations' },
    { id: 2, title: 'Customs Compliance' },
    { id: 3, title: 'Reverse Logistics' },
    { id: 4, title: 'Demand Forecasting' },
    { id: 5, title: 'Supplier Management' },
    { id: 6, title: 'Supply Chain Disruptions' },
        ...
        <div className="p-4 sm:p-6 lg:p-8 bg-gray-50 min-h-screen">
            <div className="max-w-7xl mx-auto bg-white p-6 rounded-lg shadow-md">
                <div className="flex flex-col sm:flex-row justify-between items-center mb-6">
                    <h1 className="text-2xl font-bold text-gray-800 mb-4 sm:mb-0">Review Reason</h1>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                        ...
                        <tbody className="divide-y divide-gray-200">
                            {reviewReasonsData.map((item, index) => (
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center mt-4 text-sm text-gray-600">
                    <p>Showing 1 to {reviewReasonsData.length} of {reviewReasonsData.length} entries</p>
