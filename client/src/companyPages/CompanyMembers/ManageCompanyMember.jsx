                ...
                <tr key={member.id} className="border-b border-gray-200 hover:bg-gray-50">
                  ...
                  <td className="p-3">
                    <div className="flex items-center gap-2">
                      <button onClick={() => handleEditClick(member)} className="bg-lime-500 text-white p-2 rounded-md hover:bg-lime-600"><FaPen size={12} /></button>
                      <button onClick={() => handleDelete(member.id)} className="bg-pink-600 text-white p-2 rounded-md hover:bg-pink-700"><FaTrash size={12} /></button>
                    </div>
                  </td>
                </tr>
              ))}
