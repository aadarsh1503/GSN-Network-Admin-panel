...
async function updateDisputeEnum() {
    try {
        console.log('🔄 Removing "investigating" status from disputes table...');
        
        // Read the SQL file
        const sql = fs.readFileSync('./remove_investigating_status.sql', 'utf8');
        ...
        console.log('✅ Disputes table enum updated successfully!');
        ...
        console.error('❌ Error updating disputes enum:', error);
    } finally {
        process.exit(0);
    }
}
